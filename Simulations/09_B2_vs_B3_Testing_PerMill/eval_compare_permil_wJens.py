...
from parameter import rml_file_name_bessy2_52m
from parameter import rml_file_name_bessy3_52m
...
rml_comparison_list = {}
rml_comparison_list[rml_file_name_bessy2_52m]         = 0
rml_comparison_list[rml_file_name_bessy3_52m]         = 0
...
hf_ax.set_title('PerMil transmission')

# Transmission/PerMil bandwidth
vf_ax = axs[0,1]
vf_ax.set_xlabel('Energy [eV]')
vf_ax.set_ylabel('Transmission/PerMil bandwidth [%]')
vf_ax.set_title('Transmission/bandwidth')    
...
plt.tight_layout()
plt.savefig('plot/Test_permil.pdf')
