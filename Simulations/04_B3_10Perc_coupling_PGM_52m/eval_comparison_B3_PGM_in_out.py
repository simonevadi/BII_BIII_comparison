...
from parameter import rml_file_name_bessy3_short
from parameter import rml_file_name_bessy3_long_PGM_out, rml_file_name_bessy3_long_PGM_in
...
rml_comparison_list = {}
rml_comparison_list[rml_file_name_bessy3_short]                          = 1
rml_comparison_list[rml_file_name_bessy3_long_PGM_out]                   = 1
rml_comparison_list[rml_file_name_bessy3_long_PGM_in]                    = 1
...
plt.tight_layout()
plt.savefig('plot/FluxRpFocus_comparison_B3_short_vs_long (10 Perc. coupling).pdf')
