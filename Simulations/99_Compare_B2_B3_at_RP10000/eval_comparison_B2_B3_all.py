...
from parameter import rml_file_name_bessy2_HiBeta_37m, rml_file_name_bessy2_HiBeta_56m 
from parameter import rml_file_name_bessy3_37m, rml_file_name_bessy3_56m
...
rml_comparison_list = {}
rml_comparison_list[rml_file_name_bessy2_HiBeta_37m]          = 0
rml_comparison_list[rml_file_name_bessy2_HiBeta_56m]          = 0
rml_comparison_list[rml_file_name_bessy3_37m]                 = 0
rml_comparison_list[rml_file_name_bessy3_56m]                 = 0
...
flux_ax.grid(which='major', linestyle='dotted')
...
bw_ax.grid(which='major', linestyle='dotted')
bw_ax.minorticks_on()
...
rp_ax.grid(which='major', linestyle='dotted')
rp_ax.minorticks_on()
