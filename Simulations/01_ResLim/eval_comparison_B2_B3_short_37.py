...
from parameter import rml_file_name_bessy3_short, rml_file_name_bessy3_long
from parameter import rml_file_name_bessy2_HiBeta_long, rml_file_name_bessy2_HiBeta_short
from parameter import rml_file_name_bessy2_LoBeta_long, rml_file_name_bessy2_LoBeta_short
...
rml_comparison_list = {}
#rml_comparison_list[rml_file_name_bessy3_long]         = 3
rml_comparison_list[rml_file_name_bessy3_short]         = 3
#rml_comparison_list[rml_file_name_bessy2_HiBeta_long]  = 3
#rml_comparison_list[rml_file_name_bessy2_HiBeta_short] = 3
#rml_comparison_list[rml_file_name_bessy2_LoBeta_long]  = 3
rml_comparison_list[rml_file_name_bessy2_LoBeta_short]  = 3
# set moving average window
window = 10

# prepare figures
fig, (axs) = plt.subplots(3, 2,figsize=(10,10))
fig.suptitle(f"BESSYII/BESSYIII PGM beamline comparison")
...
plt.tight_layout()
plt.savefig('plot/FluxRpFocus_comparison_B2_B3_short_37.pdf')
