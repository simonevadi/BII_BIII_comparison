...
# Load in rml file 
# BESSY II:
rml_file_name_bessy2_LoBeta_37m_errors_on    = 'bessy2lo_37m_PGM_2Perc_coupling_errors_on'

# BESSY III:
rml_file_name_bessy3_long_56m_errors_on      = 'bessy3_56m_PGM_2Perc_coupling_errors_on'
