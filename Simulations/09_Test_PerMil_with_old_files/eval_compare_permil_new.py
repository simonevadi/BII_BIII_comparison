...
for ind, es_size in enumerate(SlitSize):
     ...
     bw_source_b2 = 0.001*filtered_flux_b2['SU.photonEnergy'] #to get abs. BW
     #0.001 is para value bandwidth in perc.. Not universal!! Implement in RayPyNg
     ...
     axs_new.scatter(energy_b2, permilflux_b2, color='green')
     ...
     axs_new.set_ylabel('Transmission or Flux [arb. unit]')
