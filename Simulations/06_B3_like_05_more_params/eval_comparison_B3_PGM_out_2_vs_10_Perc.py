...
from parameter import SlitSize, grating, cff
from parameter import rml_file_name_bessy3_long_PGM_2Perc_coupling
from parameter import rml_file_name_bessy3_long_PGM_10Perc_coupling
...
# FLUX 2%
folder = 'RAYPy_Simulation_'+rml_file_name_bessy3_long_PGM_2Perc_coupling+'_FLUX'
file   = 'DetectorAtFocus_RawRaysIncoming.dat'
flux_path = os.path.join(folder, file)
flux2 = pd.read_csv(flux_path, sep='\t')
...
file   = 'DetectorAtFocus_RawRaysIncoming.dat'
flux_path = os.path.join(folder, file)
flux10 = pd.read_csv(flux_path, sep='\t')
...
fig.suptitle(f"BESSYIII PGM beamline comparison 2 vs. 10% coupling")
...
# plt.tight_layout()
# plt.savefig('plot/FluxRpFocus_comparison_B3_2_vs.10_Perc._coupling).pdf')
